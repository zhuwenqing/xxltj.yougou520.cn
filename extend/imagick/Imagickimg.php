...
{  
    ...
    */  
    ...
    public function merge(){
        ...
        $canvas->newimage(1000, 1612, 'white');
        // $canvas->setImageFormat($type);
        $canvas->setImageFormat('gif');

        // 读取图片
        $pic1 = new Imagick;
        $pic1->readImage('static/images/poster/2.gif');

        // 读取图片
        $pic2 = new Imagick;
        $pic2->readImage('static/images/poster/779b9d1f3c7c86bbf8600130e6fe0d87.gif');

        // 将图片合并到画布
        $canvas->compositeImage($pic1, Imagick::COMPOSITE_OVER, 0, 0);
        $canvas->compositeImage($pic2, Imagick::COMPOSITE_OVER, 272, 977);
        $canvas->writeimage('static/images/poster/kashf.gif');
