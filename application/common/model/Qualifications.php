...
class Qualifications extends Model
{
    ...
    public function showAllArticles(){
        return Db::name('qualifications')->select();
    }
    ...
    public function showHomeList(){
        ...
        return Db::query('SELECT id,name,quaname,publish_time,thumb FROM think_qualifications ');
    }
...
//        return Db::query('SELECT id,name,introduction,publish_time FROM think_article ');
        return Db::name('qualifications')->where(['id'=>$id])->select();
    }
    ...
    public function updataSort($id,$sort){
        ...
        return Db::query('UPDATE think_qualifications SET sort =  '.$sort.'  WHERE id = 9');
    }
