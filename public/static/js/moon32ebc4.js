...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=11,d=12,w=13,l=window.__allowLoadResFromMp?1:2,m=window.__allowLoadResFromMp?1:0,_=l+m,u=window.testenv_reshost||window.__moon_host||"res.wx.qq.com",p=new RegExp("^(http(s)?:)?//"+u);
window.__loadAllResFromMp&&(u="mp.weixin.qq.com",l=0,_=l+m);
var f=0,h={
prefix:"__MOON__",
loaded:[],
unload:[],
...
var d=new Error(a);
if(t>=0)if(m>t){
var l=e.replace("res.wx.qq.com","mp.weixin.qq.com");
h.request(l,t,n);
