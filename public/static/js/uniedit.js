function launchFullscreen(a){if(a.requestFullscreen){a.requestFullscreen()}else{if(a.mozRequestFullScreen){a.mozRequestFullScreen()}else{if(a.msRequestFullscreen){a.msRequestFullscreen()}else{if(a.webkitRequestFullscreen){a.webkitRequestFullScreen()}}}}};function exitFullscreen(){if(document.exitFullscreen){document.exitFullscreen()}else{if(document.mozCancelFullScreen){document.mozCancelFullScreen()}else{if(document.webkitExitFullscreen){document.webkitExitFullscreen()}}}};function fullscreenElement(){return document.fullscreenElement||document.webkitCurrentFullScreenElement||document.mozFullScreenElement||null};
	...
	d.ready(function(){a.on("copy",function(a){var b=a.clipboardData;b.setData("text/html",d.getContent()),alert("愤怒男孩工作室编辑器，恭喜成功复制！在微信公众平台粘贴即可！")}),d.addListener("contentChange",function(){$("#preview").html(d.getContent()+'<div><a style="font-size:12px;color:#607fa6" href="http://mp.weixin.qq.com/profile?src=3&timestamp=1473559153&ver=1&signature=rLc7w-sclckEBsqirYiMZtCUUWtsOwNI7Z3PFISw0cDWKT58K3TGTRp4sjr20yO91L3iX6TF4tCaXtqH1rJH*w==" target="_blank" id="post-user">阅读原文</a> <em style="color:#8c8c8c;font-style:normal;font-size:12px;">阅读 100000+</em><span class="fr"><a style="font-size:12px;color:#607fa6" href="http://wpa.qq.com/msgrd?v=3&uin=1556450107&site=qq&menu=yes" target="_blank">我要举报</a></span></div>')}),$(".itembox").on("click",function(){d.execCommand("insertHtml", '<section class="unieditor">' + $(this).html() + "</section><br />")})}),$(".tabs li a").on("click",function(){$(this).addClass("current").parent().siblings().each(function(){$(this).find("a").removeClass("current")}),$("#"+$(this).attr("tab")).show().siblings().hide()}),$(".itembox img,.itembox audio").each(function(){var a=$(this);a.attr("src",a.data("src"))})});
